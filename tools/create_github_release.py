...
def main():
    ...
    tag_name = "v2.0.5"
    release_title = "v2.0.5"
    
    notes_path = os.path.join("release", "release_notes_v2.0.5.md")
    ...
    assets = [
        os.path.join("release", "MeteoPlaneRadar-v2.0.5-factory.bin"),
        os.path.join("release", "MeteoPlaneRadar-v2.0.5-ota.bin")
    ]
