...
def main():
    ...
    tag_name = "v2.0.3"
    release_title = "v2.0.3: Overhead Aircraft Tracking, Swatting & Flight Chasing Animations"
    
    notes_path = os.path.join("release", "release_notes_v2.0.3.md")
    ...
    assets = [
        os.path.join("release", "MeteoPlaneRadar-v2.0.3-factory.bin"),
        os.path.join("release", "MeteoPlaneRadar-v2.0.3-ota.bin")
    ]
